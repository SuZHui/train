...
},{"./../utils":"La2s","./../core/settle":"H2iV","./../helpers/cookies":"k3ra","./../helpers/buildURL":"x8Ee","../core/buildFullPath":"PPse","./../helpers/parseHeaders":"nAs4","./../helpers/isURLSameOrigin":"qw5y","../core/createError":"wsXG","../defaults":"zBDM","../cancel/Cancel":"MqSD"}],"qAVQ":[function(require,module,exports) {
...
},{"./utils":"La2s","./helpers/normalizeHeaderName":"feM3","./core/enhanceError":"ZBIb","./adapters/xhr":"DiA2","./adapters/http":"DiA2","process":"qAVQ"}],"tLbi":[function(require,module,exports) {
'use strict';
...
},{"./../utils":"La2s","./../defaults":"zBDM"}],"oYZ2":[function(require,module,exports) {
'use strict';
...
},{"./../utils":"La2s","./transformData":"tLbi","../cancel/isCancel":"oYZ2","../defaults":"zBDM","../cancel/Cancel":"MqSD"}],"lxi1":[function(require,module,exports) {
'use strict';
...
},{"./utils":"La2s","./helpers/bind":"NwEK","./core/Axios":"koPw","./core/mergeConfig":"lxi1","./defaults":"zBDM","./cancel/Cancel":"MqSD","./cancel/CancelToken":"H1pc","./cancel/isCancel":"oYZ2","./env/data":"BSIx","./helpers/spread":"FYPw","./helpers/isAxiosError":"vzfR"}],"gI3o":[function(require,module,exports) {
module.exports = require('./lib/axios');
},{"./lib/axios":"U60K"}],"VO5s":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  getNewsItem: function getNewsItem(id) {
    return client.get("https://61e80b15e32cd90017acbfb7.mockapi.io/enterprise/news/".concat(id));
  },
...
},{"axios":"gI3o"}],"gTtB":[function(require,module,exports) {
"use strict";
...
$(document).ready(function () {
  ...
  _api.default.getNewsList(params.page, params.limit).then(function (res) {
...
function renderPagination() {
  ...
  $('.page-item.prev .page-link').attr('href', "?page=1&limit=".concat(limit));
  $('.page-item.next .page-link').attr('href', "?page=".concat(pagination.sizes, "&limit=").concat(limit));
  var nodes = Array.from({
    length: pagination.sizes
  }, function (_, i) {
    var index = i + 1;
    return $('<div class="page-item jumper">').append($('<a class="page-link">').attr('href', "?page=".concat(index, "&limit=").concat(limit)).text(index));
  });
  $('.pagination .prev').after(nodes);
...
function renderNewsList() {
  ...
  list.forEach(function (news) {
    var a = $('<a></a>').attr('href', "detail.html?id=".concat(news.id)).addClass('col-12 col-md-6 col-sm-6 col-lg-3 mb-4');
    var image = $('<div class="news-image"></div>');
    image.append($('<img width="100%" height="160px" class="lazyload" data-sizes="auto"/>').attr({
      'data-src': news.img,
      'src': 'https://i.stack.imgur.com/ATB3o.gif'
    }));
    var info = $('<div class="news-info"></div>').append($('<h4 class="title"></h4>').text(news.title)).append($('<span class="date"></span>').text((0, _dayjs.default)(news.date).format('YYYY.MM.DD'))).append($('<p class="desc"></p>').text(news.desc));
    $('<div class="news-item"></div>').append(image).append(info).appendTo(a);
    wrapper.append(a);
  });
}
},{"dayjs":"XZPv","./api":"VO5s"}]},{},["gTtB"], null)
//# sourceMappingURL=/list.900330f2.js.map