...
$(document).ready(function () {
  var page = getPageIndex() || 1;

  _api.default.getNewsList(page).then(function (res) {
    renderNewsList(res);
...
function renderNewsList() {
  ...
  list.forEach(function (news) {
    var a = $('<a></a>').attr('href', "detail.html?id=".concat(news.id)).addClass('col-12 col-md-6 col-sm-6 col-lg-3 mb-2');
...
//# sourceMappingURL=/list.89162595.js.map