...
function renderDetail(data) {
  ...
  var image = $('<div class="mx-auto col-12 col-md-7"></div>').append($('<img class="w-100 lazyload" data-sizes="auto" />').attr('data-src', data.img));
  var desc = $('<p class="col-12 py-2"></p>').text(data.desc);
  var content = $('<div class="row"></div>').append([image, desc]);
  $('.detail').append([title, content]);
}
},{"./api":"VO5s"}]},{},["FUi9"], null)
//# sourceMappingURL=/detail.6be16cf1.js.map